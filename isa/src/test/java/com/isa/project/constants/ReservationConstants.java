...
public class ReservationConstants {
    ...
    public static final Service DB_COTTAGE = new Cottage(1L, "Koliba Aladin i Sinovi", "Prelepa koliba", "Nema pusenja unutra", 30, new HashSet<>(), new HashSet<>(), new CottageOwner(), new HashSet<>(), 3, new HashSet<>(), new HashSet<>(), new HashSet<>(), new HashSet<>(), new HashSet<>(), new Location()) ;
