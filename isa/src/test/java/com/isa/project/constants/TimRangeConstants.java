...
public class TimRangeConstants {
    ...
    public static final Long DB_SERVICE_ID = 2L;
    ...
    public static final Date NEW_START_DATE = new GregorianCalendar(2022, Calendar.JULY, 20).getTime();
    public static final Date NEW_END_DATE = new GregorianCalendar(2022, Calendar.JULY, 25).getTime();
