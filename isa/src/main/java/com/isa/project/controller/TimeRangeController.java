...
//    @PreAuthorize("hasRole('COTTAGE_OWNER') || hasRole('BOAT_OWNER') || hasRole('INSTRUCTOR')")
//    @CrossOrigin(origins = "http://localhost:4200")
//    @PostMapping(consumes = "application/json", value = "unavailablePeriod/{id}")
//    public ResponseEntity<ServiceDTO> createUnavailablePeriod(@RequestBody TimeRangeDTO timeRangeDTO, @PathVariable Long id) {
//
...
//                if (serviceService.isFreePeriodValid(unavailablePeriod)) {
...
//                if (serviceService.isFreePeriodValid(unavailablePeriod)) {
//                    serviceService.addUnavailablePeriod(unavailablePeriod);
//                    return new ResponseEntity<>(new ServiceDTO(adventure), HttpStatus.OK);
//                } else {
//                    return new ResponseEntity<>(new ServiceDTO(adventure), HttpStatus.BAD_REQUEST);
//                }
//            }
//        }
//        return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
//    }
    ...
    public ResponseEntity<AdventureDTO> createFreePeriodForAdventure(@RequestBody TimeRangeDTO timeRangeDTO) {
        ...
        Adventure adventure = adventureService.findById(timeRangeDTO.getServiceId());
