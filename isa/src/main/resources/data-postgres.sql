...
INSERT INTO public.app_user_user_role(user_id, role_id) VALUES (3, 6);
...
INSERT INTO public.app_user_user_role(user_id, role_id) VALUES (4, 2);

INSERT INTO public.boat_owner(id, address, app_user_type, city, country, email, enabled, last_password_reset_date, name, password, surname, telephone) VALUES (nextval('user_seq_gen'), 'Puskinova 4', 1, 'Novi Sad', 'Serbia', 'mila@gmail.com', true, null, 'Mila', '$2a$10$ZOy/T/.nqSeJZ7rUU9b2Z.hREwrLXVfKRUhjcBJWyTUmMkIVC0YYS', 'Milic', '+381603211415');
INSERT INTO public.app_user_user_role(user_id, role_id) VALUES (3, 1);
...
INSERT INTO public.adventure(id, behavior_rules, description, last_update_date, max_number_of_people, name, price_per_day, service_type, version, cancellation, fishing_gear, instructor_biography, instructor_id) VALUES (nextval('service_seq_gen'), 'Nema psovanja', 'Najzanimljivija pecaroska avantura', null, 20, 'Pecajte s nama', 40, 2, 0, 0, 'Varalice', 'Mnogo dobar instruktor', 3);
INSERT INTO public.location (city, latitude, longitude, "number", street, zip_code, service_id) VALUES ('Belgrade', '44.78932489153337', '20.448370203245677', '4', 'Качаничка', '11000', 2);
...
INSERT INTO public.time_range(available, end_date, start_date, service_id) VALUES (false, '2022-06-15 00:00:00', '2022-06-09 00:00:00', 2);
...
INSERT INTO public.time_range(end_date, start_date, service_id) VALUES ('2022-06-30 00:00:00', '2022-06-10 00:00:00', 2);
...
INSERT INTO public.action(duration_in_days, max_number_of_people, price, start_time, service_id) VALUES (3, 3, 70, '2022-06-20 00:00:00', 2);
